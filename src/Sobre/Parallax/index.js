...
function Parallax() {
    return (
        <Container>
            <div class="parallax">
            <p className='text_sobre'>Formados na área de beleza desde 2008, os sócios Rogerio e Diovani cruzaram suas jornadas de trabalho em 2012, onde estreitaram seus laços de amizade e profissional, levando-os a fundar, em dezembro de 2014, o JD Studio.
